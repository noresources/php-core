...
interface MessageManagerImplementation
{
...
class MessageManager
{
	...
	public static function setImplementation(MessageManagerImplementation &$impl)
	{
	...
	/**
	 *
	 * @var MessageManagerImplementation
	 */
	private static $m_implementation;
}

class DummyMessageManagerImplementation implements MessageManagerImplementation
{
...
MessageManager::setImplementation(new DummyMessageManagerImplementation());
