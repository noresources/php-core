...
class ArrayUtil
{
	 ...
	 */
	public static function keyRemove(&$table, $key)
	{
...
{
	return ArrayUtil::keyRemove($table, $key);
}

function is_array($table)
{
	return ArrayUtil::isArray($table);
}

function to_array($anything, $singleElementKey = 0)
{
	return ArrayUtil::createArray($anything, $singleElementKey);
}

function is_associative_array(&$values)
{
	return ArrayUtil::isAssociative($values);
}

function count($table)
{
	return ArrayUtil::count($table);
}

function array_reset(&$table)
{
	return ArrayUtil::reset($table);
}

function array_key_exists($key, $table)
{
	return ArrayUtil::keyExists($table, $key);
}

function array_keyvalue(&$table, $key, $a_defaultValue = null)
{
	return ArrayUtil::keyValue($table, $key, $a_defaultValue);
}

function array_implode_values($table, $glue)
{
	return ArrayUtil::implodeValues($table, $glue);
}

function array_implode_keys($table, $glue)
{
	return ArrayUtil::implodeKeys($table, $glue);
}

function array_implode_cb($table, $glue, $callback, $callbackArguments = null)
{
	return ArrayUtil::implode($table, $glue, $callback);
}
